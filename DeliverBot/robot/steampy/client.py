...
import json
import requests
from robot.steampy import guard
from robot.steampy.confirmation import ConfirmationExecutor
from robot.steampy.exceptions import SevenDaysHoldException, LoginRequired
from robot.steampy.login import LoginExecutor, InvalidCredentials
from robot.steampy.market import SteamMarket
from robot.steampy.models import Asset, TradeOfferState, SteamUrl, GameOptions
from robot.steampy.utils import text_between, texts_between, merge_items_with_descriptions_from_inventory, \
